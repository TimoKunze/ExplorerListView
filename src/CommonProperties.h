...
///
/// \sa ExplorerListView, StringProperties
//////////////////////////////////////////////////////////////////////
...
protected:
	...
	///
	/// \sa <a href="https://msdn.microsoft.com/en-us/library/bb774835(VS.85).aspx">LVN_GETINFOTIP</a>
	...
	///
	/// \sa <a href="https://msdn.microsoft.com/en-us/library/bb774845(VS.85).aspx">LVN_ITEMCHANGED</a>
	...
	struct Controls
	{
		...
		/// \brief <em>Wraps the listview displaying the values for the \c CallBackMask property</em>
		CCheckListViewCtrl callBackMaskList;
