...
/// \brief <em>Common constants for \c ExplorerListView and \c ShellBrowser</em>
///
/// This file defines common constants for \c ShellBrowser and \c ExplorerListView.
///
/// \sa ExplorerListView
//////////////////////////////////////////////////////////////////////
...
#include "IInternalMessageListener.h"
	...
	typedef struct SHBHANDSHAKE
	{
		...
		/// \c ShellBrowser is able to determine whether the window it tries to attach to supports the required
		/// interfaces.
		BOOL processed;
		/// \brief <em>Holds the error code in case the message failed</em>
		HRESULT errorCode;
		/// \brief <em>Holds the build number of the \c ShellBrowser control that sent the message</em>
		UINT shellBrowserBuildNumber;
		/// \brief <em>If \c TRUE, the sending \c ShellBrowser control is an Unicode build</em>
		...
		/// \brief <em>Receives the \c IInternalMessageListener implementation of \c ExplorerListView</em>
		///
		/// Receives the implementation of the \c IInternalMessageListener interface of \c ExplorerListView.
		///
		/// \sa IInternalMessageListener
		IInternalMessageListener** ppCtlInternalMessageHook;
		/// \brief <em>Receives a pointer to the control's \c IUnknown interface</em>
		///
	...
	//////////////////////////////////////////////////////////////////////
	/// \name Common ShellBrowser messages
	///
	//@{
	/// \brief <em>Sent by \c ShellBrowser to the control window as handshake to exchange interface pointers and so on</em>
	///
