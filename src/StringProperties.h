...
///
/// \sa ExplorerListView, CommonProperties
//////////////////////////////////////////////////////////////////////
...
public:
	...
	StringProperties();
		...
		BEGIN_COM_MAP(StringProperties)
			...
			//COM_INTERFACE_ENTRY(IPropertyPage2, IPropertyPage)
		END_COM_MAP()
...
protected:
	...
	struct Properties
	{
		...
		/// \brief <em>The buffered value of the \c EmptyMarkupText property</em>
		CAtlString emptyMarkupText;
		/// \brief <em>The buffered value of the \c FooterIntroText property</em>
		CAtlString footerIntroText;

		Properties()
		{
			propertyToEdit = -1;
			selectedPropertyItemID = -1;
			emptyMarkupText = TEXT("");
			footerIntroText = TEXT("");
		}
	} properties;
