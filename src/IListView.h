...
/// \brief <em>Interface for working with listviews</em>
///
/// This interface is implemented by listview controls (comctl32.dll version 6.x on Windows Vista). It is
/// used to configure the control.\n
...
///     <a href="https://www.geoffchappell.com/studies/windows/shell/comctl32/controls/listview/interfaces/ilistview/index.htm">IListView</a>
//////////////////////////////////////////////////////////////////////
...
public:
	...
	virtual HRESULT STDMETHODCALLTYPE SetSubItemCallback(ISubItemCallback* pCallback) = 0;
...
/// \brief <em>Interface for working with listviews</em>
///
/// This interface is implemented by listview controls (comctl32.dll version 6.x on Windows 7). It is used
...
public:
	...
	virtual HRESULT STDMETHODCALLTYPE MapIdToIndex(int itemID, PINT pItemIndex) = 0;
	virtual HRESULT STDMETHODCALLTYPE IsItemVisible(LVITEMINDEX itemIndex, BOOL* pVisible) = 0;
	virtual HRESULT STDMETHODCALLTYPE EnableAlphaShadow(BOOL fEnable) = 0;
	virtual HRESULT STDMETHODCALLTYPE GetGroupSubsetCount(PINT pNumberOfRowsDisplayed) = 0;
	virtual HRESULT STDMETHODCALLTYPE SetGroupSubsetCount(int numberOfRowsToDisplay) = 0;
	virtual HRESULT STDMETHODCALLTYPE GetVisibleSlotCount(PINT pCount) = 0;
	virtual HRESULT STDMETHODCALLTYPE GetColumnMargin(RECT* pMargin) = 0;
